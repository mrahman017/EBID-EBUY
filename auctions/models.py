...
# defining the models of category from Djanjo
...
# defining the model of an auction listing from Djanjo
...
# defining the model of a bid on an item
...
# defining the model of a comment or rating on an item
...
# defining the model of a watchlist for an OU
